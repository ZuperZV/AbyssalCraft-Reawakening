...
import net.zuperzv.abyssalcraft_reawakening.commonCode.component.EnergyEntry;
import net.zuperzv.abyssalcraft_reawakening.commonCode.component.ModDataComponentTypes;
import net.zuperzv.abyssalcraft_reawakening.commonCode.component.StaffTargetData;
import net.zuperzv.abyssalcraft_reawakening.commonCode.data.EnergyType;
