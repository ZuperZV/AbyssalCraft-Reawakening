...
public class WitherwoodShelfBlockEntityRender implements BlockEntityRenderer<ModShelfBlockEntity, ShelfRenderState> {
    private static final float ITEM_SIZE = 0.25F;
    private static final float ALIGN_ITEMS_TO_BOTTOM = -0.25F;
    private final ItemModelResolver itemModelResolver;

    public WitherwoodShelfBlockEntityRender(BlockEntityRendererProvider.Context context) {
    ...
    public void extractRenderState(ModShelfBlockEntity blockEntity, ShelfRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
