...
public class NeoForgeAttributeRegistryHelper implements IAttributeRegistryHelper {
    ...
    @Override
    public void applyEntityAttributeRegistrations(IAttributeRegistryHelper.EntityAttributeRegistrar registrar) {
    ...
    private record AttributeEntry<T extends LivingEntity>(Supplier<EntityType<T>> entityTypeSupplier,
        ...
        private void register(IAttributeRegistryHelper.EntityAttributeRegistrar registrar) {
